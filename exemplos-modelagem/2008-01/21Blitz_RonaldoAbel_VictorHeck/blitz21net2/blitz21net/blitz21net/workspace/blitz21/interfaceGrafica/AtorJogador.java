...
public class AtorJogador extends JFrame {
	...
	private void initialize() {
		...
		this.setTitle("Blitz 21 Demo 666");
		tab = new Tabuleiro();
		tab.iniciar();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			Icon vazia2 = new ImageIcon(getClass().getResource("vazia2.gif"));
			Icon vazia3 = new ImageIcon(getClass().getResource("vazia3.gif"));
			Icon topo = new ImageIcon(getClass().getResource("topo.gif"));
			Icon base = new ImageIcon(getClass().getResource("base.gif"));
			Icon lat = new ImageIcon(getClass().getResource("lat.gif"));
			Icon lat2 = new ImageIcon(getClass().getResource("lat.gif"));
			
			vMensagem = new JLabel();
			vMensagem.setBounds(new Rectangle(25, 10, 200, 20));
			vMensagem.setText("Bem Vindo ao 21 Blitz");
	...
	public void exibirEstado() {
		...
		Icon C1O=new ImageIcon(getClass().getResource("1-O.JPG"));
		Icon C2O=new ImageIcon(getClass().getResource("2-O.JPG"));
		Icon C3O=new ImageIcon(getClass().getResource("3-O.JPG"));
		Icon C4O=new ImageIcon(getClass().getResource("4-O.JPG"));
		Icon C5O=new ImageIcon(getClass().getResource("5-O.JPG"));
		Icon C6O=new ImageIcon(getClass().getResource("6-O.JPG"));
		Icon C7O=new ImageIcon(getClass().getResource("7-O.JPG"));
		Icon C8O=new ImageIcon(getClass().getResource("8-O.JPG"));
		Icon C9O=new ImageIcon(getClass().getResource("9-O.JPG"));
		Icon C10O=new ImageIcon(getClass().getResource("10-O.JPG"));
		Icon C11O=new ImageIcon(getClass().getResource("11-O.JPG"));
		Icon C12O=new ImageIcon(getClass().getResource("12-O.JPG"));
		Icon C13O=new ImageIcon(getClass().getResource("13-O.JPG"));
		
		Icon C1P=new ImageIcon(getClass().getResource("1-P.JPG"));
		Icon C2P=new ImageIcon(getClass().getResource("2-P.JPG"));
		Icon C3P=new ImageIcon(getClass().getResource("3-P.JPG"));
		Icon C4P=new ImageIcon(getClass().getResource("4-P.JPG"));
		Icon C5P=new ImageIcon(getClass().getResource("5-P.JPG"));
		Icon C6P=new ImageIcon(getClass().getResource("6-P.JPG"));
		Icon C7P=new ImageIcon(getClass().getResource("7-P.JPG"));
		Icon C8P=new ImageIcon(getClass().getResource("8-P.JPG"));
		Icon C9P=new ImageIcon(getClass().getResource("9-P.JPG"));
		Icon C10P=new ImageIcon(getClass().getResource("10-P.JPG"));
		Icon C11P=new ImageIcon(getClass().getResource("11-P.JPG"));
		Icon C12P=new ImageIcon(getClass().getResource("12-P.JPG"));
		Icon C13P=new ImageIcon(getClass().getResource("13-P.JPG"));
		
		Icon C1E=new ImageIcon(getClass().getResource("1-E.JPG"));
		Icon C2E=new ImageIcon(getClass().getResource("2-E.JPG"));
		Icon C3E=new ImageIcon(getClass().getResource("3-E.JPG"));
		Icon C4E=new ImageIcon(getClass().getResource("4-E.JPG"));
		Icon C5E=new ImageIcon(getClass().getResource("5-E.JPG"));
		Icon C6E=new ImageIcon(getClass().getResource("6-E.JPG"));
		Icon C7E=new ImageIcon(getClass().getResource("7-E.JPG"));
		Icon C8E=new ImageIcon(getClass().getResource("8-E.JPG"));
		Icon C9E=new ImageIcon(getClass().getResource("9-E.JPG"));
		Icon C10E=new ImageIcon(getClass().getResource("10-E.JPG"));
		Icon C11E=new ImageIcon(getClass().getResource("11-E.JPG"));
		Icon C12E=new ImageIcon(getClass().getResource("12-E.JPG"));
		Icon C13E=new ImageIcon(getClass().getResource("13-E.JPG"));
		
		Icon C1C=new ImageIcon(getClass().getResource("1-C.JPG"));
		Icon C2C=new ImageIcon(getClass().getResource("2-C.JPG"));
		Icon C3C=new ImageIcon(getClass().getResource("3-C.JPG"));
		Icon C4C=new ImageIcon(getClass().getResource("4-C.JPG"));
		Icon C5C=new ImageIcon(getClass().getResource("5-C.JPG"));
		Icon C6C=new ImageIcon(getClass().getResource("6-C.JPG"));
		Icon C7C=new ImageIcon(getClass().getResource("7-C.JPG"));
		Icon C8C=new ImageIcon(getClass().getResource("8-C.JPG"));
		Icon C9C=new ImageIcon(getClass().getResource("9-C.JPG"));
		Icon C10C=new ImageIcon(getClass().getResource("10-C.JPG"));
		Icon C11C=new ImageIcon(getClass().getResource("11-C.JPG"));
		Icon C12C=new ImageIcon(getClass().getResource("12-C.JPG"));
		Icon C13C=new ImageIcon(getClass().getResource("13-C.JPG"));	
		...
		for (int linha=1; linha<5; linha++){
			for (int coluna=1; coluna<6; coluna++){
				...
				if ((coluna==1 && linha==1) || (coluna==1 && linha==2) || (coluna==1 && linha==4) )
